...
func TestClassifyS3RequestActions(t *testing.T) {
	tests := []struct {
		...
		{name: "pop bucket object", method: http.MethodPost, target: "/api/pop/bucket/scanner", want: "PopObject"},
		{name: "pop global object", method: http.MethodPost, target: "/api/pop/_all/archive", want: "PopObject"},
		{name: "pop method unsupported", method: http.MethodGet, target: "/api/pop/bucket/scanner", want: unsupportedS3Action},
