...
func TestClassifyS3RequestActions(t *testing.T) {
	tests := []struct {
		...
		{name: "put bucket encryption unsupported", method: http.MethodPut, target: "/bucket?encryption", want: unsupportedS3Action},
		{name: "get bucket encryption unsupported", method: http.MethodGet, target: "/bucket?encryption", want: unsupportedS3Action},
		{name: "delete bucket encryption unsupported", method: http.MethodDelete, target: "/bucket?encryption", want: unsupportedS3Action},
